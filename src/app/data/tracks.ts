...
export const Tracks: { [key in TrackId]: { id: key } & TrackDefinition } = {
  jingle: {
    id: TrackId["jingle"],
    url: "assets/audio/faded/jingle.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  ...
  tutorial_test: {
    ...
    url: "assets/audio/faded/zkusebni lr track.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  intro_1_1: {
    id: TrackId["intro_1_1"],
    url: "assets/audio/faded/1.1.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  ambient_FF: {
    id: TrackId["ambient_FF"],
    url: "assets/audio/faded/INTERAKCE FF ambient.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_1_2: {
    id: TrackId["prechod_1_2"],
    url: "assets/audio/faded/1.2.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_1_3: {
    id: TrackId["prechod_1_3"],
    url: "assets/audio/faded/1.3.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  ambient_park: {
    id: TrackId["ambient_park"],
    url: "assets/audio/faded/INTERAKCE PARK ambient.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_1_3_a: {
    id: TrackId["interakce_1_3_a"],
    url: "assets/audio/faded/1.3.int.a.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_1_3_b: {
    id: TrackId["interakce_1_3_b"],
    url: "assets/audio/faded/1.3.int.b.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_1_3_c: {
    id: TrackId["interakce_1_3_c"],
    url: "assets/audio/faded/1.3.int.c.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_1_4: {
    id: TrackId["prechod_1_4"],
    url: "assets/audio/faded/1.4.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_1_5: {
    id: TrackId["prechod_1_5"],
    url: "assets/audio/faded/1.5.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  ambient_konicek: {
    id: TrackId["ambient_konicek"],
    url: "assets/audio/faded/INTERAKCE KONICEK AMBIENT.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_1_5_a: {
    id: TrackId["interakce_1_5_a"],
    url: "assets/audio/faded/1.5.int.a.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_1_5_b: {
    id: TrackId["interakce_1_5_b"],
    url: "assets/audio/faded/1.5.int.b.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_1_6A: {
    id: TrackId["prechod_1_6A"],
    url: "assets/audio/faded/1.6A.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_1_6B: {
    id: TrackId["prechod_1_6B"],
    url: "assets/audio/faded/1.6B.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  ambient_materialy_1: {
    id: TrackId["ambient_materialy_1"],
    url: "assets/audio/faded/DM 1 ambient.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_2_1: {
    id: TrackId["prechod_2_1"],
    url: "assets/audio/faded/2.1.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  ambient_marianske: {
    id: TrackId["ambient_marianske"],
    url: "assets/audio/faded/INTERAKCE MARIANSKE ambient.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_2_1_a: {
    id: TrackId["interakce_2_1_a"],
    url: "assets/audio/faded/2.1.int.a.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_2_1_b: {
    id: TrackId["interakce_2_1_b"],
    url: "assets/audio/faded/2.1.int.b.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_2A_2: {
    id: TrackId["prechod_2A_2"],
    url: "assets/audio/faded/2A.2.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  ambient_damu: {
    id: TrackId["ambient_damu"],
    url: "assets/audio/faded/INTERAKCE DAMU ambient.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_2A_2_int1_a: {
    id: TrackId["interakce_2A_2_int1_a"],
    url: "assets/audio/faded/2A.2.int1.a.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_2A_2_int1_b: {
    id: TrackId["interakce_2A_2_int1_b"],
    url: "assets/audio/faded/2A.2.int1.b.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_2A_3: {
    id: TrackId["prechod_2A_3"],
    url: "assets/audio/faded/2A.3.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_2A_3_parada: {
    id: TrackId["interakce_2A_3_parada"],
    url: "assets/audio/faded/2.int.parada.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_2A_3_int3_a_b: {
    id: TrackId["interakce_2A_3_int3_a_b"],
    url: "assets/audio/faded/2A.3.int3.a+b.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_2A_3_int4_b: {
    id: TrackId["interakce_2A_3_int4_b"],
    url: "assets/audio/faded/2A.3.int4.b.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_2A_3_int5_a: {
    id: TrackId["interakce_2A_3_int5_a"],
    url: "assets/audio/faded/2A.3.int5.a.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_2A_3_klementinum: {
    id: TrackId["prechod_2A_3_klementinum"],
    url: "assets/audio/faded/2A.3.klementinum.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  ambient_damu_klementinum: {
    id: TrackId["ambient_damu_klementinum"],
    url: "assets/audio/faded/ATMO DAMU-KLEMENTINUM.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_2A_4: {
    id: TrackId["prechod_2A_4"],
    url: "assets/audio/faded/2A.4.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_2B_2: {
    id: TrackId["prechod_2B_2"],
    url: "assets/audio/faded/2B.2.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_2B_3: {
    id: TrackId["prechod_2B_3"],
    url: "assets/audio/faded/2B.3.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  ambient_klementinum: {
    id: TrackId["ambient_klementinum"],
    url: "assets/audio/faded/INTERAKCE KLEMETNINUM AMB.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_2B_3_a: {
    id: TrackId["interakce_2B_3_a"],
    url: "assets/audio/faded/2B.3.int.a.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_2B_3_b: {
    id: TrackId["interakce_2B_3_b"],
    url: "assets/audio/faded/2B.3.int.b.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_2B_4: {
    id: TrackId["prechod_2B_4"],
    url: "assets/audio/faded/2B.4.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  ambient_betlemske: {
    id: TrackId["ambient_betlemske"],
    url: "assets/audio/faded/INTERAKCE BETLEMSKE AMB.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_2B_4_int1_a: {
    id: TrackId["interakce_2B_4_int1_a"],
    url: "assets/audio/faded/2B.4.int1.a.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_2B_4_int1_b: {
    id: TrackId["interakce_2B_4_int1_b"],
    url: "assets/audio/faded/2B.4.int1.b.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_2B_5: {
    id: TrackId["prechod_2B_5"],
    url: "assets/audio/faded/2B.5.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_2B_5_int2_a: {
    id: TrackId["interakce_2B_5_int2_a"],
    url: "assets/audio/faded/2B.5.int2.a.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_2B_5_int2_b: {
    id: TrackId["interakce_2B_5_int2_b"],
    url: "assets/audio/faded/2B.5.int2.b.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_2B_6: {
    id: TrackId["prechod_2B_6"],
    url: "assets/audio/faded/2B.6.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_3A_1: {
    id: TrackId["prechod_3A_1"],
    url: "assets/audio/faded/3A.1.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_3A_1_a: {
    id: TrackId["interakce_3A_1_a"],
    url: "assets/audio/faded/3A.1.int.a.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_3A_1_b: {
    id: TrackId["interakce_3A_1_b"],
    url: "assets/audio/faded/3A.1.int.b.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_3A_2: {
    id: TrackId["prechod_3A_2"],
    url: "assets/audio/faded/3A.2.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_3B_1: {
    id: TrackId["prechod_3B_1"],
    url: "assets/audio/faded/3B.1.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_3B_1_a: {
    id: TrackId["interakce_3B_1_a"],
    url: "assets/audio/faded/3B.1.int.a.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_3B_1_b: {
    id: TrackId["interakce_3B_1_b"],
    url: "assets/audio/faded/3B.1.int.b.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_3B_2: {
    id: TrackId["prechod_3B_2"],
    url: "assets/audio/faded/3B.2.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_3_3: {
    id: TrackId["prechod_3_3"],
    url: "assets/audio/faded/3.3.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  ...
  interakce_3_3_a: {
    ...
    url: "assets/audio/faded/3.3.int.a.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  interakce_3_3_b: {
    id: TrackId["interakce_3_3_b"],
    url: "assets/audio/faded/3.3.int.b.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_4_1: {
    id: TrackId["prechod_4_1"],
    url: "assets/audio/faded/4.1.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_4_2A: {
    id: TrackId["prechod_4_2A"],
    url: "assets/audio/faded/4.A.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_4_2B: {
    id: TrackId["prechod_4_2B"],
    url: "assets/audio/faded/4.2B.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  ambient_roh_narodni: {
    id: TrackId["ambient_roh_narodni"],
    url: "assets/audio/faded/INTERAKCE NARODKA AMB.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
  prechod_5: {
    id: TrackId["prechod_5"],
    url: "assets/audio/faded/5.mp3",
    type: "audio",
    mimeType: "audio/mpeg",
  },
};
